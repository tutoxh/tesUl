    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Selamat Datang Di Rest-APIs AgatZNail</h3>
            <p>
...
Jika Kamu Memiliki Masalah, Silahkan Hubungin Saya Via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6285811523745">WhatsApp</a></span></span>
            <span style="display: block;"><br>By,<br>AgatZ</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"AgatZ" <agatdwisubakti335@gmail.com>',
        to: email,
        subject: 'Verify Email - Api AgatZNail',
        html: inboxGmail,
      };
